  ...
  return (
    <div name="about"  className='text-white w-full h-screen bg-gradient-to-b from-black via-black to-gray-800'>
      <div className='max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full '>
         ...
         Hello! I'm Tushar Gosavi, a passionate and dedicated software developer with a knack for creating innovative and user-friendly web applications. I hold a strong background in full-stack development, with a particular focus on React and Node.js.
